...
export const statusIoFormatter = data => {
  const statusCode = data.data.data.result.status_overall.status_code;
  const status = data.data.data.result.status_overall.status;
...
export const statusIoIncidentFormatter = data => {
  return data.data.data.result.incidents.map(incident => {
